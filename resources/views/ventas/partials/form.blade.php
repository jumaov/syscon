<div class="col-sm-4">
	...
	<p>	------------------------INFORMACION  GENERAL------------------------</p>
	  ...
	  <div class="form-group">
	  	  {!! Form::text('nombre', null, ['class' => 'form-control floating-label', 'placeholder' => 'Cliente:', 'required']) !!}
...
<div class="col-sm-12">	  
	  <div class="form-group">
	  	  {!! Form::textarea('notas', null, [ 'class' =>'form-control floating-label', 'rows' =>'7', 'placeholder' => 'Comentario de la Venta:']) !!}
	  </div>
</div> 